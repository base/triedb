...
impl Clone for PageError {
    fn clone(&self) -> Self {
        match self {
            Self::PageNotFound(id) => Self::PageNotFound(id.clone()),
            Self::PageOccupied(id) => Self::PageOccupied(id.clone()),
            Self::PageDirty(id) => Self::PageDirty(id.clone()),
            Self::PageLimitReached => Self::PageLimitReached,
            Self::InvalidRootPage(id) => Self::InvalidRootPage(id.clone()),
            ...
            Self::InvalidPageContents(id) => Self::InvalidPageContents(id.clone()),
        }
    }
}
